...
#### 1.1. Обоснованность рахработки продукта 
...
- Сократиться нагрузка на андеррайтеров
##### Критерии успеха
- Модели обладает разделяющей способностью большей, чем андеррайтер; >= 40 GINI.

Некорректный прогноз означает увеличение потерь в результате невозврата крелитов недобросовестными заемщиками.
...
Дальнейшим развитием проекта будет являтся увеличение количества моделей и улучшение их точности.
