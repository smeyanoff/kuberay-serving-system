...
class MDataModel(BaseModel):
    ...
    def values_to_dmatrix(self) -> xgboost.core.DMatrix:
        return xgboost.DMatrix(
            data=[self.values_to_list()], feature_names=self.get_labels()
        )


class DataModel(MDataModel):
